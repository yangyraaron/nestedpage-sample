...
var createHandler = function( sequential ) {
	...
	return function( name, reverse, $to, $from ) {
		...
		var deferred = new $.Deferred(),
			...
			startOut = function() {
				$from.css('-webkit-transform','translateX(0)');
				$from.css('-webkit-transition','-webkit-transform 1000ms ease-out');	

				if(reverse){
					$from.css('-webkit-transform','none');
				}else{
					$from.css('-webkit-transform','translateX(-50%)');	
				}
				...
				// 	$from.css('-webkit-transform','none');
				// }else{
				// 	$from.css('-webkit-transform','translateX(-100%)');	
				// }
			},
			...
			startIn = function() {
				if(!none&&!reverse){
					$to.css('-webkit-transform','translateX(50%)');
				}
				$to.css('-webkit-transition','-webkit-transform 1000ms ease-out');
